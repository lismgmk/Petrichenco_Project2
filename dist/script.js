...
/* harmony import */ var _modules_formDz__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/formDz */ "./src/js/modules/formDz.js");
...
/* harmony import */ var _modules_accordeon__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/accordeon */ "./src/js/modules/accordeon.js");
/* harmony import */ var _modules_burger__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/burger */ "./src/js/modules/burger.js");
...
/* harmony import */ var _modules_dropLittle__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/dropLittle */ "./src/js/modules/dropLittle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_formDz__WEBPACK_IMPORTED_MODULE_7__["default"])(modalState);
  ...
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_11__["default"])('.accordion-heading');
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_12__["default"])('.burger-menu', '.burger');
  ...
  Object(_modules_dropLittle__WEBPACK_IMPORTED_MODULE_15__["default"])();
});
...
var accordeon = function accordeon(trigger) {
...
var drop = function drop() {
  ...
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(function (eventItem) {
    inputs.forEach(function (input) {
      input.addEventListener(eventItem, function (e) {
        preventDef(e);
      }, false);
      console.log(1);
    });
  ...
  ;
  ['dragenter', 'dragover'].forEach(function (eventItem) {
    inputs.forEach(function (input) {
      input.addEventListener(eventItem, function () {
        showDrag(input);
      }, false);
    });
  });
  ['dragleave', 'drop'].forEach(function (eventItem) {
    inputs.forEach(function (input) {
      input.addEventListener(eventItem, function () {
        unShowDrag(input);
      }, false);
  ...
  ['drop'].forEach(function (eventItem) {
    inputs.forEach(function (input) {
      input.addEventListener(eventItem, function (e) {
...
var dropLittle = function dropLittle() {
  ...
  function doFetch(event) {
    ...
    postData('assets/question.php', formData1).then(function (res) {
      console.log(res);
      console.log('54');
    }).catch(function () {
      console.log('error');
...
/* harmony default export */ __webpack_exports__["default"] = (dropLittle);
    ...
    markAll.forEach(function (item) {
      ...
      if (markType) {
        markType.forEach(function (element) {
          element.style.display = 'block', element.classList.add('animated', 'fadeIn');
        });
      } else {
...
var formDz = function formDz(state) {
  ...
  form.forEach(function (element) {
    if (element.getAttribute('data-dz') === 'dz') {
      element.addEventListener("submit", function (e) {
        e.preventDefault(); // console.log(calcPriceBlock.innerHTML)
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_1__["postData"])('assets/question.php', formData).then(function (data) {
...
/* harmony default export */ __webpack_exports__["default"] = (formDz);
...
/* harmony import */ var _formDz__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./formDz */ "./src/js/modules/formDz.js");
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusImg.getAttribute('src', message.spinner);
      statusImg.classList.add('animated', 'fadeInUp');
      statusMessage.appendChild(statusImg);
      var textMessage = document.createElement('div');
      textMessage.textContentc = message.loading;
      ...
      if (item.getAttribute('data-dz') === 'dz') {
        Object(_formDz__WEBPACK_IMPORTED_MODULE_7__["default"])();
      }
...
var mask = function mask(selector) {
  var setCoursorePosition = function setCoursorePosition(pos, elem) {
    elem.focus();
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var destroyImg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      var display;
      document.querySelectorAll('[data-modals]').forEach(function (item) {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var widthTop = document.documentElement.scrollTop,
          //число пикселей до начала
      hash = this.hash,
          // часть адресной строки после #
      toBlock = document.querySelector(hash).getBoundingClientRect().top,
          // то куда скролим координаты (берем через св-во ТОП)
      start = null;
      ...
      function step(time) {
        ...
        console.log(toBlock); // console.log(time);

        console.log(widthTop); // console.log(speed);
...
var showMoreStyles = function showMoreStyles(trigger, wrapperSelector) {
  var btn = document.querySelector(trigger),
      wrapper = document.querySelector(wrapperSelector); // moreStyles.forEach(item => {
